...
class Player {
    ...
    update(keys, entities, audio) {
        ...
        if (isCurrentlySmall && !wantCrouch && !wantTumble) {
            ...
            for (let entity of entities) {
                if (entity.isDestroyed || entity.type === 'hallway' || entity.type === 'door' || entity.type.startsWith('targetDoor') || entity.type === 'tutorialbook' || entity.type === 'obj_collect' || entity.type === 'left-up' || entity.type === 'right-up' || entity.type === 'tile') continue;
        ...
        entities.forEach(entity => {
            ...
            if (entity.type === 'hallway' || entity.type === 'door' || entity.type.startsWith('targetDoor') || entity.type === 'tutorialbook' || entity.type === 'obj_collect' || entity.type === 'slope' || entity.type === 'ladder' || entity.type === 'tile') return;
        ...
        if (this.isClimbing && !this.isWalled) {
            ...
            if (!stillTouching) {
                ...
                entities.forEach(entity => {
                    if (entity.isDestroyed || entity.type === 'hallway' || entity.type === 'tutorialbook' || entity.type === 'obj_collect' || entity.type === 'slope' || entity.type === 'tile') return;
